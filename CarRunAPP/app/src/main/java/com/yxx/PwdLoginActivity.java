...
import com.yxx.examapp.CreateDbHelper;
import com.yxx.examapp.MainActivity;
import com.yxx.R;
import com.yxx.RegisterLoginActivity;

public class PwdLoginActivity extends AppCompatActivity {
    private com.yxx.examapp.CreateDbHelper dbHelper;
    ...
    dbHelper=new CreateDbHelper(this,"a.db",null,1);
