...
public class RealQuestionAdapter extends RecyclerView.Adapter<RealQuestionAdapter.ViewHolder> {
    private List<com.examapp.RealQuestion>realQuestionList;
    ...
    public RealQuestionAdapter(List<com.examapp.RealQuestion>realQuestions){
      ...
      final ViewHolder holder=new ViewHolder(view);
        ...
        holder.box.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.examapp.RealQuestion realQuestion=realQuestionList.get(position);
