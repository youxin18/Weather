...
import com.examapp.CreateThoughtQuestionHelper;
import com.examapp.RealQuestion;
import com.examapp.RealQuestionAdapter;
...
public class ThoughtActivity extends AppCompatActivity {
    ...
    private List<com.examapp.RealQuestion>realQuestionList=new ArrayList<>();
    ...
    private void loadThoughtQuestionData() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                com.examapp.RealQuestion realQuestion=new RealQuestion(title);
